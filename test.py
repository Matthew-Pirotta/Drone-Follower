...
def track_people(tracker, detections, frame):
...
def assign_person_id(face_encoding, face_db, used_person_ids, next_person_id):
...
def process_tracked_objects(tracked_objects, frame, face_db, person_id_map, used_person_ids, next_person_id, last_position, last_area, pixel_threshold):
    ...
    for track in tracked_objects:
        ...
        if face_locations:
            ...
            if face_encodings:
                ...
                assigned_id, next_person_id = assign_person_id(face_encodings[0], face_db, used_person_ids, next_person_id)
        # Store mapping
        ...
        if assigned_id == 1:
            ...
            last_position, last_area = track_movement(assigned_id, person_x, person_y, current_area, last_position, last_area, pixel_threshold)
    return last_position, last_area

def track_movement(assigned_id, person_x, person_y, current_area, last_position, last_area, pixel_threshold):
...
def main():
    ...
    face_db, person_id_map, used_person_ids = {}, {}, set()
    next_person_id, last_position, last_area = 1, None, None
